...
"""
DEXORZO Innovations
MT5 AutoTrader V8.9 - Fast Dynamic M5
...
APP_TITLE = "MT5 AUTOTRADER V8.9 - FAST DYNAMIC M5"
...
TRADES_FILE=REPORT/"v8_9_dynamic_m5_trades.csv"
STATE_FILE=RUNTIME/"v8_9_day_state.json"
STOP_FILE=Path("STOP_V8_9")
PAUSE_FILE=Path("PAUSE_V8_9")
RESUME_FILE=Path("RESUME_V8_9")
# Runtime state for partial-take-profit management.
PARTIAL_STATE_FILE=RUNTIME/"v8_9_partial_state.json"
...
def guard():
    ...
    if "MetaQuotes-Demo" not in str(a.server or ""):
        raise RuntimeError(f"SAFETY LOCK: V8.9 is restricted to MetaQuotes-Demo. Current server: {a.server}")
    ...
    try:
        while True:
            ...
            if ctl=="STOP":
                ...
                dashboard(a,[],states,last,"STOP_V8_9 active - halted",{},0,{},[],{})
                break
            manage_positions()
